            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="UpReports.aspx">Uploaded Reports</a></li>                       
                        <li><a href="Patient.aspx">Add Patient</a></li>
                        <li><a href="PReports.aspx">Pending Reports</a></li>
                        <li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Account<b class="caret"></b></a>
				  <ul class="dropdown-menu">
					<li  id="mbtn"><a href="#">Change password</a></li>
                                    ...
                                    <div class="panel panel-skin" style="margin-left:300px;margin-top:50px">
                                        ...
                                        <div class="panel-body">
                                            <form runat="server" class="lead">
                                                ...
                                                <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="btnUpload_Click" class="btn btn-skin btn-block btn-lg" />
                                                <br />
